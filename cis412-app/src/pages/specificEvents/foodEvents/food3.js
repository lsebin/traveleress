...
import mapImage from '../../../images/food3.png';
    ...
    return (
        <div style={containerStyle}>
            <header className="meetup-header">
                ...
                <p style={{marginTop: '4px', }}>Spicy ramen contest!</p>
            </header>
            <section className="meetup-details">
                ...
                <div className="event-info-specific">
                    <div class="row justify-content-between"> 
                        ...
                        <div class="col-2">
                            <div className="participation-box-event">2/10</div>
                        </div>
                    </div>
                </div>
                <div style={{ height: '5px' }}></div>
                <div className="event-desc">
                    Like spicy food? Like ramen? Like spicy ramen? This contest is FOR YOU! Finish this
                    restaurant's level-20 spicy ramen in under 15 minutes for free!!
                </div>
                <div className="event-info-container">
                    <div className="event-info-section">
                        <div className="event-info-dt">Date</div>
                        <div className="event-date">May 08, 2024</div>
                    </div> 
                    <div className="event-info-section">
                        <div className="event-info-dt">Time</div>
                        <div className="event-time">5:30PM - 8:30PM</div>
                    </div>  
                </div>
                ...
                <div>
                    ...
                    <ul className="qa-list">
                        <li>
                            <strong>Q:</strong> Is level 20 their highest level D: 
                            <p><strong>A:</strong> I heard they go up to 25...</p>
                        </li>
                        <li>
                            <strong>Q:</strong> Is hospital fee included 
                            <p><strong>A:</strong> BYOH</p>
                        </li>
                    </ul>
                </div>
                <div>
