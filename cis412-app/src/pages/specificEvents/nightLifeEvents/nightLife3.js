...
import mapImage from '../../../images/nightlife3.png';
    ...
    return (
        <div style={containerStyle}>
            <header className="meetup-header">
                ...
                <p style={{marginTop: '4px', }}>Best bar for sporting events!</p>
            </header>
            <section className="meetup-details">
                ...
                <div className="event-info-specific">
                    <div class="row justify-content-between"> 
                        ...
                        <div class="col-2">
                            <div className="participation-box-event">7/15</div>
                        </div>
                    </div>
                </div>
                <div style={{ height: '5px' }}></div>
                <div className="event-desc">
                    Friday night NBA watch party at the best NYC sporting bar! Looking for other
                    NBA enjoyers to have a lovely night. 
                </div>
                <div className="event-info-container">
                    ...
                    <div className="event-info-section">
                        ...
                        <div className="event-time">10PM - 12AM</div>
                    </div>  
                </div>
                ...
                <div>
                    ...
                    <ul className="qa-list">
                        <li>
                            <strong>Q:</strong> Which team do you support (there is a right answer)
                            <p><strong>A:</strong> We shall discuss in person... :D</p>
                        </li>
                    </ul>
                </div>
                <div>
