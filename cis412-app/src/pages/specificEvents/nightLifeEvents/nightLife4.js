...
import mapImage from '../../../images/nightlife4.png';
    ...
    return (
        <div style={containerStyle}>
            <header className="meetup-header">
                ...
                <p style={{marginTop: '4px', }}>Club with best hispanic music</p>
            </header>
            <section className="meetup-details">
                ...
                <div className="event-info-specific">
                    <div class="row justify-content-between"> 
                        ...
                        <div class="col-2">
                            <div className="participation-box-event">9/15</div>
                        </div>
                    </div>
                </div>
                <div style={{ height: '5px' }}></div>
                <div className="event-desc">
                    One can never have a bad night out with hispanic music playing in the background.
                </div>
                <div className="event-info-container">
                    <div className="event-info-section">
                        <div className="event-info-dt">Date</div>
                        <div className="event-date">May 19, 2024</div>
                    </div> 
                    <div className="event-info-section">
                        <div className="event-info-dt">Time</div>
                        <div className="event-time">9PM - 11PM</div>
                    </div>  
                </div>
                ...
                <div>
                    ...
                    <ul className="qa-list">
                        <li>
                            <strong>Q:</strong> Are we planning on going to other bars before/after?
                            <p><strong>A:</strong> Yes! Pregame plans coming up</p>
                        </li>
                        <li>
                            <strong>Q:</strong> Any public transportation around the bar? 
                            <div><strong>A:</strong> Yes, it's 3-min walk away from the 7 Av station!</div>
                        </li>
                    </ul>
                </div>
                <div>
