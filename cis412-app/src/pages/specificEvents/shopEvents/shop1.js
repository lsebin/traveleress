...
import mapImage from '../../../images/thrifting1.png';
    ...
    return (
        <div style={containerStyle}>
            <header className="meetup-header">
                ...
                <p style={{marginTop: '4px', }}>Thrifting haul around NYC!</p>
            </header>
            <section className="meetup-details">
                ...
                <div className="event-desc">
                    So many hidden gems in them NYC streets in terms of thrift stores! Looking to 
                    expand your summer wardrobe? Look no further than this haul with me :D.
                </div>
                <div className="event-info-container">
                    <div className="event-info-section">
                        <div className="event-info-dt">Date</div>
                        <div className="event-date">May 05, 2024</div>
                    </div> 
                    <div className="event-info-section">
                        <div className="event-info-dt">Time</div>
                        <div className="event-time">1PM - 4PM</div>
                    </div>  
                </div>
                ...
                <div>
                    ...
                    <ul className="qa-list">
                        <li>
                            <strong>Q:</strong> How many stores do you plan on going to? 
                            <p><strong>A:</strong> Yes. (Maybe around 6?)</p>
                        </li>
                        <li>
                            <strong>Q:</strong> What's our  transportation method between thrift store? 
                            <p><strong>A:</strong> Most likely the subway, but also some of them are closer together so walking as well!</p>
                        </li>
                    </ul>
                </div>
                <div>
